...
import { 
  ...
  Activity, Clock, Power, RefreshCw
} from 'lucide-react'
    ...
    const loadConsumptionData = async () => {
      ...
      try {
        ...
        if (timeRange === 'week') {
          ...
          const rawData = startDateStr && endDateStr
            ? await fetchConsumptionRange(startDateStr, endDateStr)
            : []
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">
                    {timeRange === 'week'
                      ? 'Akumulasi Senin-Kamis per minggu di bulan berjalan'
                      : 'Grafik perbandingan beban energi sektoral'}
                  </p>
                </div>
