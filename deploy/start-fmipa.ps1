# =============================================================
#  Smart Energy Dashboard - FMIPA UNESA
#  Startup script: XAMPP (MySQL + Apache) + Backend + Frontend
#  Dipanggil oleh Windows Task Scheduler saat boot.
#
#  CATATAN: ini template hasil copy dari start-fisipol.ps1 — belum
#  pernah dijalankan di Mini PC FMIPA yang sebenarnya. Sebelum
#  di-deploy, PASTIKAN dulu:
#   - $Proj di bawah cocok dengan lokasi folder proyek sebenarnya
#     di Mini PC FMIPA (path saat ini cuma dugaan mengikuti pola
#     FISIPOL: C:\Users\<user>\Downloads\unesa-psikologi-main\unesa-psikologi-main)
#   - XAMPP (MySQL+Apache) memang terpasang di Mini PC itu di lokasi
#     C:\xampp — kalau tidak, sesuaikan atau hapus bagian XAMPP kalau
#     Mini PC FMIPA memakai MySQL terpusat, bukan lokal.
# =============================================================
$ErrorActionPreference = 'SilentlyContinue'

$Proj = 'C:\Users\fmipa\Downloads\unesa-psikologi-main\unesa-psikologi-main'
